...
public interface PromotionLotteryService {
    ...
    List<PromotionLotteryDetailResp> openActivities(Long userId) throws BizException;

    PromotionLotteryRecordResp draw(Long userId, Long activityId) throws BizException;

    List<PromotionLotteryRecordResp> userRecords(Long userId, Integer limit) throws BizException;
}